...
export default function ContactPage() {
  ...
  async function submit(event) {
    ...
    try {
      ...
      setStatus("success");
      setMessage(data.message || "Thanks. We will get back to you shortly.");
    } catch (error) {
      setStatus("error");
    ...
    <main className="relative min-h-screen bg-[#121110] px-6 pb-28 pt-36 text-[#F5F2EC] overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid gap-16 lg:grid-cols-[0.9fr_1.1fr] items-start">
          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="mt-6 text-base leading-relaxed text-white/70 font-medium max-w-md">
                Tell us what you are trying to improve, integrate, automate, or scale. The more context you share, the better we can prepare.
              </p>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-white/10">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/40">Direct Email</p>
                  <p className="font-medium text-white truncate">contact@tendrils.io</p>
                </div>
                <ArrowUpRight size={16} className="text-white/40 group-hover:text-[#C9A227] transition-colors mr-2" />
              </a>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/40">Phone Support</p>
                  <p className="font-medium text-white truncate">+1 (214) 302-9093</p>
                </div>
                <ArrowUpRight size={16} className="text-white/40 group-hover:text-[#C9A227] transition-colors mr-2" />
              </a>
              ...
              <div className="flex items-start gap-4 rounded-2xl border border-white/10 bg-[#1A1816]/80 p-4">
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/40">Global Headquarters</p>
          ...
          <form onSubmit={submit} className="rounded-[2.5rem] border border-white/10 bg-[#1A1816]/90 p-8 md:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
            ...
            {message && (
              <p className={`mt-4 text-center text-sm font-medium ${status === "error" ? "text-red-400" : "text-emerald-400"}`}>
                {message}
              </p>
            )}
          </form>
